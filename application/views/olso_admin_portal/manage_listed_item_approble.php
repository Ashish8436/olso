						...
						<div class="panel-body">
							<div class="table-responsive">
								<table class="table table-striped table-bordered table-hover dataTables-example" >
									...
									<tbody>
										<?php $i=1; foreach ($un_approble_items as $unapprobe): ?>
											<tr class="gradeX">
												<td><?php echo $i;$i++; ?></td>
												<td>
													<a href="<?= base_url('Admin-portal/Unapproble-Item-Details') ?>/<?php echo $unapprobe->random_itemno ?>/<?php echo $unapprobe->item_name ?>" >
														<?php echo $unapprobe->oauth_uid ?>
													</a>
												</td>
												<td>
													<a href="" >
														<?php echo $unapprobe->first_name ?> <?php echo $unapprobe->last_name ?>
													</a>
												</td>
												<th>
													<?php echo $unapprobe->random_itemno ?>
												</th>
