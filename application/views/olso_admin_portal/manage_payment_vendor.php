						...
						<div class="panel-body">
							<div class="table-responsive">
								<table class="table table-striped table-bordered table-hover dataTables-example" >
									...
									<tbody>
										<?php $i=1; foreach ($all_transaction_vendors as $tran_vendors): ?>
											<tr class="gradeX">
												<td><?php echo $i;$i++; ?></td>
												<td>
													<a href="<?= base_url('Admin-portal/Transactions-details')?>?payment_id=<?php echo $tran_vendors->payment_id;?>&lender_id=<?php echo $tran_vendors->vendor_id;?>" >
														<?php echo $tran_vendors->vendor_id ?>
													</a>
												</td>
												<td>
													<a href="<?= base_url('Admin-portal/Transactions-details')?>?payment_id=<?php echo $tran_vendors->payment_id;?>&lender_id=<?php echo $tran_vendors->vendor_id;?>" >
														<?php echo strtoupper($tran_vendors->first_name) ?> <?php echo strtoupper($tran_vendors->last_name) ?>
													</a>
												</td>
