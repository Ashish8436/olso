    ...
    $(document).ready(function () {
        ...
        var calendar = $('#calendar').fullCalendar({
            ...
            select: function (start, end, allDay) {
                ...
                var title = prompt('Enter Time this formet ( HH:MM AM/PM):',time);
                ...
                if (title) {
                    ...
                    if(start<today1){
                        ...
                        $.ajax({
                            url: "<?php echo base_url(); ?>Tools/add_event_for_update/<?php echo $fetch_user_adv_book_month->item_id?>",
            ...
            eventClick: function (event) {
                //var deleteMsg = confirm("Do you really want to delete?");
                    ...
                    if (event.id!='') {
                        $.ajax({
                            type: "POST",
                            url: "<?php echo base_url(); ?>Tools/update_delete_event",
                            data: "&id=" + event.id,
                            success: function (response) {
