      ...
      <br><br>
			...
			<div class="content-area5 dashboard-content">
                     ...
                     <div class="col-md-12 mt-3 mt-md-0">
                        <div class="verify card mt-4 mb-4">
                          <div class="card-body text-center">
                            <h4 class="mb-4">Verified Documents</h4>
                            <div class="progress">
                              <?php if($fetch_id_verification->driving_license1 !=''){$a=16;}else{$a=0;} ?>
                              <?php if($fetch_id_verification->passport1 !=''){$b=16;}else{$b=0;} ?>
                              <?php if($fetch_id_verification->aadhar_card1 !=''){$c=16;}else{$c=0;} ?>
                              <?php if($fetch_user_documents->voter_id1 !=''){$d=16;}else{$d=0;} ?>
                              <?php if($fetch_user_documents->stu_emp_id1 !=''){$e=16;}else{$e=0;} ?>
                              <?php if($fetch_user_documents->rent_bill1 !=''){$f=16;}else{$f=0;} ?>
                              <?php if($fetch_id_verification->selfi !=''){$g=4;}else{$g=0;} ?>
                              <div class="progress-bar bg-success" role="progressbar" style="width: <?php echo $a+$b+$c+$d+$e+$f+$g ?>%;" aria-valuenow="25" aria-valuemin="0"aria-valuemax="100" >
                                <?php echo $a+$b+$c+$d+$e+$f+$g ?>%
                              </div>
                            </div>
                            ...
                            <div class="targetMe">
                              <div class="card mt-4 shadow-sm mb-2 py-2">
                                <div class="card-body d-md-flex justify-content-between align-items-center py-2" id="targetMe">
                                  ...
                                  <img src="<?= base_url('assets/img/10-512.png');?>" alt="check" class="align-self-center" style="max-width:2rem;">
                                </div>
                              </div>
                            </div>
                            <?php }else{ ?>
                            ...
                            <?php if($fetch_user_documents->voter_id1 !=''){ ?>
                              ...
                              <div class="card mt-4 shadow-sm mb-2 py-2">
                                <div class="card-body d-md-flex justify-content-between align-items-center py-2" id="targetMe">
                                  <div class="align-self-center">
                                    <span class="bg-primary p-2 rounded-circle"><i class="fa fa-address-card text-light"></i></span>
                                    <span class="content">Voter ID</span>
                        ...
                        <?php if($fetch_user_documents->stu_emp_id1 !=''){ ?>
                          ...
                          <div class="card mt-4 shadow-sm mb-2 py-2">
                            <div class="card-body d-md-flex justify-content-between align-items-center py-2" id="targetMe">
                              <div class="align-self-center">
                                <span class="bg-primary p-2 rounded-circle"><i class="fa fa-address-card text-light"></i></span>
                                <span class="content">Student ID / Employee ID</span>
                        ...
                        <?php if($fetch_user_documents->rent_bill1 !=''){ ?>
                          ...
                          <div class="card mt-4 shadow-sm mb-2 py-2">
                            <div class="card-body d-md-flex justify-content-between align-items-center py-2" id="targetMe">
                              <div class="align-self-center">
                                <span class="bg-primary p-2 rounded-circle"><i class="fa fa-address-card text-light"></i></span>
                                <span class="content">Rent agreement / Utility Bill</span>
                        ...
                        <?php }else{ ?>
                        <?php } ?> 
                        <?php if($fetch_id_verification->selfi !=''){ ?>
                          <div class="targetMe">
                          <div class="card mt-4 shadow-sm mb-2 py-2">
                            <div class="card-body d-md-flex justify-content-between align-items-center py-2" id="targetMe">
                              <div class="align-self-center">
                                <span class="bg-primary p-2 rounded-circle"><i class="fa fa-address-card text-light"></i></span>
                                <span class="content">Selfi</span>
                    ...
                    <div class="card border">
                        ...
                        <?php endif; ?>
                      <?php if($fetch_user_documents->voter_id1!='' && $fetch_user_documents->stu_emp_id1!='' && $fetch_user_documents->rent_bill1!=''){ ?>

                      <?php } else { ?>
                      <div class="card-body">
                        <section class="multi_step_form mt-2" style="height:650px;  ">
                          <form method="post" action="<?= base_url('Add-Documents'); ?>" enctype="multipart/form-data" id="msform">
                            <!-- Tittle -->
                            <div class="tittle">
                              <h2>
                                Optional ID
                            ...
                            <fieldset>
                              <?php if($fetch_id_verification->driving_license1 ==''){ ?>
                                <div class="card mt-4 shadow-sm mb-3 py-2">
                                  <div
                                    class="card-body d-md-flex justify-content-between align-items-center py-2"
                                  >
                                    <div class="align-self-center">
                                    ...
                                    <button
                                      class="uploads btn btn-success mt-md-auto mt-3"
                                      type="button"
                                    >
                                      upload
                                    </button>
                                ...
                                <div class="card mt-4 shadow-sm mb-3 py-2">
                                  ...
                                  >
                                    <div class="align-self-center">
                                      ...
                                      ></span>
                                      <span class="content"
                                        >Student ID / Employee ID</span
                                      >
                                    </div>
                                    <button
                                      class="uploads btn btn-success mt-3 mt-md-auto"
                                      type="button"
                                    >
                                      upload
                                    </button>
                                ...
                                <div class="card mt-4 shadow-sm mb-3 py-2">
                                  ...
                                  >
                                    <div class="align-self-center">
                                      ...
                                      ></span>
                                      <span class="content"
                                        >Rent agreement / Utility Bill</span
                                      >
                                    </div>
                                    <button
                                      class="uploads btn btn-success mt-md-auto mt-3"
                            ...
                            <fieldset>
                              ...
                              <h6>
                                Please upload this documents to verify your Identity.
                              </h6>
                              <div class="passport">
                              ...
                              <input type="submit" class="action-button" name="submit">
                            </fieldset>
                          </form>
                        </section>
                        <!-- End Multi step form -->
