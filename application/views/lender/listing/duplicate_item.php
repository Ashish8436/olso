				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<form id="rootwizard-2" class="form-wizard validate-form-wizard validate" method="post" action="<?= base_url('Items-Duplicate_Store'); ?>" enctype="multipart/form-data">
										...
										<div class="row"> 
											<div class="col-md-12"> 
												<div class="form-group"> 
													...
													<input type="text" name="item_name" class="form-control" placeholder="Item Name" id="item_name" minlength="5" required>
												</div>
											</div> 
											<div class="col-md-12"> 
												<div class="form-group"> 
