						...
						<div class="panel-body">
							...
							<ul class="comments-list removeable-list">
								<li>
									...
									<a href="#/" class="remove"><img src="<?= base_url('assets/lender_assets/images/icon-close.png');?>" alt="Remove" title="Remove"></a>								
								</li>
								<li>
									...
									<div class="item gallery active">
										<div class="row">
											<div class="col-sm-6">
												<div class="product-view">
													<div class="product-thumb">
														<img class="img-responsive" title="" alt="" src="<?= base_url('assets/lender_assets/images/alarm.jpg');?>">													
													</div>
											...
											<div class="col-sm-6">
												<div class="product-view">
													<div class="product-thumb">
														<img class="img-responsive" title="" alt="" src="<?= base_url('assets/lender_assets/images/annual-book.jpg');?>">													
													</div>
													<div class="product-detail">
										...
										<div class="row">
											<div class="col-sm-6">
												<div class="product-view">
													<div class="product-thumb">
														<img class="img-responsive" title="" alt="" src="<?= base_url('assets/lender_assets/images/chocolate.jpg');?>">													
													</div>
													<div class="product-detail">
											...
											<div class="col-sm-6">
												<div class="product-view">
													<div class="product-thumb">
														<img class="img-responsive" title="" alt="" src="<?= base_url('assets/lender_assets/images/clock.jpg');?>">													
													</div>
													<div class="product-detail">
										...
										<div class="row">
											<div class="col-sm-6">
												<div class="product-view">
													<div class="product-thumb">
														<img class="img-responsive" title="" alt="" src="<?= base_url('assets/lender_assets/images/running-shoe.jpg');?>">													
													</div>
													<div class="product-detail">
											...
											<div class="col-sm-6">
												<div class="product-view">
													<div class="product-thumb">
														<img class="img-responsive" title="" alt="" src="<?= base_url('assets/lender_assets/images/snooker.jpg');?>">													
													</div>
													<div class="product-detail">
										...
										<div class="row">
											<div class="col-sm-6">
												<div class="product-view">
													<div class="product-thumb">
														<img class="img-responsive" title="" alt="" src="<?= base_url('assets/lender_assets/images/headphone.jpg');?>">													
													</div>
													<div class="product-detail">
											...
											<div class="col-sm-6">
												<div class="product-view">
													<div class="product-thumb">
														<img class="img-responsive" title="" alt="" src="<?= base_url('assets/lender_assets/images/camera.jpg');?>">													
													</div>
													<div class="product-detail">
