;(function($) {
    ...
    function verificationForm(){
        ...
        $(".next").click(function () {
            ...
            current_fs.siblings().find("h6.photos").html(`Please take the Selfi`);
...
current_fs.next().find("h6").html(`Please take the back and front photo of the ${docText}`);
current_fs.next().find("doc_name").html(`<input type="hidden" name="doc_type" value="${docText}">`);
...
$("#as1").on('change',function(e){

    let fileName = e.target.files[0].name;
    $('.custom-file-label').html(fileName);
})

$("#as2").on('change',function(e){
